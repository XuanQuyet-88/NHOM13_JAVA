...
public class QLyDHForm extends javax.swing.JFrame {
    ...
    private void fillTable() {
        ...
        for (DonHang o : listDH) {
            double tongTien = o.getSoLuongMua() * tinhTienTheoMaSP(o.getMaSP()); // Tổng tiền gốc
            String tongTienTrieuDong = String.format("%.2f triệu", tongTien / 1_000_000); // Chuyển sang triệu đồng
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(225, 225, 225)
                        .addComponent(btnTTNV, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (txtNgay.getText().equals("")) {
            ...
            try {
                ...
                String input = txtNgay.getText().trim();

                // Kiểm tra nếu chuỗi chứa chữ cái (không hợp lệ)
                if (!input.matches("\\d{1,2}/\\d{1,2}/\\d{4}")) {
                    sb.append("Ngày không hợp lệ. Vui lòng nhập đúng định dạng (dd/MM/yyyy) \n");
                    txtNgay.setBackground(Color.gray);
                } else {
                    Date inputDate = sdf.parse(input); // Chuyển đổi chuỗi sang đối tượng Date
                    Date currentDate = new Date(); // Lấy thời điểm hiện tại

                    if (inputDate.after(currentDate)) { // Kiểm tra nếu ngày nhập sau ngày hiện tại
                        sb.append("Ngày không được vượt quá thời điểm hiện tại \n");
                        txtNgay.setBackground(Color.gray);
                    } else {
                ...
                sb.append("Định dạng ngày không hợp lệ (dd/MM/yyyy). Vui lòng nhập lại \n");
                txtNgay.setBackground(Color.gray);
            }
        }
