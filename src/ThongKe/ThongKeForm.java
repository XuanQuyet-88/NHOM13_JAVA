...
public class ThongKeForm extends javax.swing.JFrame {
    ...
    private void fillTable() {
        ...
        for (SanPham o : listSP) {
            String tongTienNhapTrieu = String.format("%.2f triệu", tinhTienTheoSLN(o.getMaSP()) / 1_000_000);
            String tongTienXuatTrieu = String.format("%.2f triệu", tinhTienTheoSLX(o.getMaSP()) / 1_000_000);
            tblModel.addRow(new String[]{
                o.getMaSP(),
                String.valueOf(tongSLN(o.getMaSP())),
                tongTienNhapTrieu, // Tổng tiền nhập (triệu đồng)
                String.valueOf(tongSLX(o.getMaSP())),
                tongTienXuatTrieu, // Tổng tiền xuất (triệu đồng)
                String.valueOf(tongSLCo(o.getMaSP()) + tongSLN(o.getMaSP()) - tongSLX(o.getMaSP()))
            });
        }
