...
public class DangKyForm extends javax.swing.JFrame {
        ...
        if (isValidTK(username) == listTK.size()) {
            if (isValidPassword(txtMK.getText())) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Mật khẩu không hợp lệ, mật khẩu phải gồm ít nhất 8 kí tự, bao gồm cả chữ, số, viết hoa, viết thường và cả những kí tự đặc biệt",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangKyForm.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
